...
import { ColumnDef, parseColumnDef, MysqlResultSet, parseResultSetHeader, readUpdateResult, columnDefColType, columnDefName, isEofPacket } from "@/lib/com/mysql/query"
...
function doPrepare(fd: int, sql: string): MysqlPreparedStatement {
    ...
    return new MysqlPreparedStatement(fd, ok.statementId, ok.numParams, paramDefs, paramTypes, paramValues, paramDoubles, paramNullBits, columnDefs, 0)
}
