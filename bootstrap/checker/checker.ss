...
function initChecker() {
    ...
    const strFns = "readLine,readFile,shell,arg,getenv,listDir,sha256,tcpRead,fromCharCode,base64Encode,base64Decode,_ss_inotify_poll,doubleBits,doubleToStringExact"
    ...
    const oneArgFns = "readFile,shell,arg,exit,system,parseInt,parseDouble,doubleBits,bitsToDouble,doubleToStringExact,getenv,listDir,sha256,fromCharCode,base64Encode,base64Decode,tcpListen,tcpAccept,tcpClose,mkdir,mkdirp,fileExists,removeFile,fileSize,_ss_popen_read,exec,_ss_inotify_close,ref"
