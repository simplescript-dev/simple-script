    ...
    while (pos < srcLen) {
        ...
        if (peek() == "$" && peekNext() == "{") {
            ...
            while (pos < srcLen) {
                ...
                } else if (ch == "`") { lexTemplate() } else if (ch == "\"") { lexString() } else if (isDigit(ch)) { lexNumber() } else if (isAlpha(ch) || ch == "_") { lexIdent() } else if (ch == "+") { lexPlus() } else if (ch == "-") { lexMinus() } else if (ch == "*") { emit("STAR", "*"); advance() } else if (ch == "/") { emit("SLASH", "/"); advance() } else if (ch == "(") { emit("LPAREN", "("); advance() } else if (ch == ")") { emit("RPAREN", ")"); advance() } else if (ch == "[") { emit("LBRACKET", "["); advance() } else if (ch == "]") { emit("RBRACKET", "]"); advance() } else if (ch == ",") { emit("COMMA", ","); advance() } else if (ch == ".") { emit("DOT", "."); advance() } else if (ch == ":") { emit("COLON", ":"); advance() } else if (ch == "?") { emit("QUESTION", "?"); advance() } else if (ch == "=") { lexEq() } else if (ch == "!") { lexBang() } else if (ch == "<") { lexLt() } else if (ch == ">") { lexGt() } else if (ch == "&") { lexAnd() } else if (ch == "|") { lexOr() } else {
