...
> 本节仅作**入口速查**。**完整规则已迁至 `docs/3-MNK.md`**(PSM 九问 / VCM 六验 / 改动分层 / 收尾 gate / 八股自检 / rule 问答收敛循环 / 特定领域 gate / Fractal 承载全文)。两处内容以 `docs/3-MNK.md` 为准。
...
详细 9 问 / 6 验 / 三档档位 / 收尾四步 / 八股自检 / rule 子问卷 / reset 双重 gate / 反射扩容协议等全部在 `docs/3-MNK.md`。每次接到任务先回头读该文件。
