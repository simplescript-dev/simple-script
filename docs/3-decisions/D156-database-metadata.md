...
| 1 | INFORMATION_SCHEMA 协议查询 helper(infoSchemaQuery / infoSchemaQueryString / infoSchemaQueryInt)+ 9 cross-module accessor + ≥20 case unit test | `<phase1-hash>` |
