...
### Phase 4: checker 4 case 写 nSetS2 接管 + 5 helper 自然 sleep + MAP_LIT D145 选项 A partial(含 D084 rewrite)[✓] Done at commit `<placeholder>` (2026-05-03)
