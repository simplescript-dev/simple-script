...
## Role
Senior technical architect. Project: SimpleScript (self-bootstrapping compiled language, ~13755 LOC).
...
### 项目状态
- **文件大小**: checker.ss ~730, check_stmts.ss ~628, gen_class.ss ~613, gen_decls.ss ~593, parser.ss ~559, parse_exprs.ss ~531, parse_stmts.ss ~519, gen_runtime.ss ~507, gen_calls.ss ~507.
- **Stdlib**: 20 modules, ~4862 LOC in lib/.
- **Bootstrap**: 35 files, ~13755 LOC, 78 phase5 tests.
...
- **phase5 tests**: 78 tests.
- **35 bootstrap files**, ~13755 LOC.
...
- File sizes: checker.ss ~730 (largest), check_stmts.ss ~628, gen_class.ss ~613, gen_decls.ss ~593.
...
- 35 bootstrap files total, ~13755 LOC, 78 phase5 tests.
